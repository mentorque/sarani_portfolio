  ...
  const contactInfo = [
    {
      ...
      label: "Phone",
      value: "+353-899651367",
      href: "tel:+353899651367"
    },
    {
      icon: Mail,
      label: "Email",
      value: "saraninath.official@gmail.com",
      href: "mailto:saraninath.official@gmail.com"
    },
    {
      icon: MapPin,
      label: "Location",
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/in/sarani-nath/"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Ready to discuss talent acquisition opportunities or explore how I can help build your team
            </p>
          </div>
